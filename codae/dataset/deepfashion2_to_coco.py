# create single COCO annotation json from multiple training annotation json
...
def df2_to_coco(dataset_path):
    ...
    for num in range(1,191965):
        ...
        json_path = os.path.join( working_path, "annos/") + json_name

        image_name = str(num).zfill(6)+'.jpg'
        image_path = os.path.join( working_path, "image/" ) + image_name
        ...
        with open(json_path, 'r') as f:
            ...
            for i in tmp:
                ...
                if i == 'source' or i=='pair_id':
                    ...
                    box = tmp[i]['bounding_box']
                    w = box[2]-box[0]
                    h = box[3]-box[1]
                    x_1 = box[0]
                    y_1 = box[1]
                    bbox=[x_1,y_1,w,h]
                    cat = tmp[i]['category_id']
                    style = tmp[i]['style']
                    seg = tmp[i]['segmentation']
                    landmarks = tmp[i]['landmarks']
...
if __name__ == "__main__":
    ...
    print("Consolidating training jsons to single COCO json ...")

    df2_to_coco(dataset_path)
